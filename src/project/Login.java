...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.getAccessibleContext().setAccessibleName("phone");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            boolean login = remote.login(jTextField1.getText(), jPasswordField1.getText());
            if (login) {
                //Welcome welcome = new Welcome();
                Welcome.main(new String[]{jTextField1.getText()});
                //elcome.setVisible(true);
                dispose();
            }
            else{
                JOptionPane.showMessageDialog(rootPane, "invalid phone or password");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
